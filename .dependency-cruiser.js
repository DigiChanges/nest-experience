  ...
  forbidden: [
    ...
    },
    {
      ...
      from: {
        path: '^(src)',
        pathNot: [
          'src/initTestServer\\.ts$', // Exclude src/initTestServer.ts
    ...
    {
      name: 'domain-not-to-infra-or-presentation',
      comment: 'El dominio no debe importar de infraestructura ni de presentación',
      severity: 'error',
      from: {
        path: '^src/.*/Domain/', // Ruta para los archivos en la capa de Dominio
      },
      to: {
        pathNot: [
          '^src/.*/Domain/',
    ...
    },
    {
      ...
      comment: 'The presentation layer do not should be import from infrastructure.',
      severity: 'error',
      from: {
      ...
      to: {
        pathNot: [
          '^src/.*/Presentation/',
          '^src/.*/Domain/',
          '^src/Main/Infrastructure/UseCases/*',
          '^src/Config/*/',
          '^src/Shared/*/',
          'node_modules'
        ],
...
// generated: dependency-cruiser@16.0.0 on 2023-12-31T22:39:48.653Z
